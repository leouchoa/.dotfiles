...
configs.setup({
  ...
  org_capture_templates = {
    ...
    T = {
      description = 'Todo',
      template = '* TODO %?\n  DEADLINE: %T',
      target = '~/Sync/org/todo/things_todo.org',
    },
    w = {
      description = 'Work todo',
      template = '* TODO %?\n  DEADLINE: %T',
      target = '~/Sync/org/work/work_todo.org',
    },
    d = {
      description = 'Daily',
      template = '* Daily %T \n  %?',
      target = '~/Sync/org/daily/daily_todo.org',
      headline = 'Meetings',
    },
    c = {
      description = 'Clipboard',
      template = '* [[%x][%?]]',
      target = '~/Sync/org/intersting_urls/intersting_urls.org',
    },
  },
